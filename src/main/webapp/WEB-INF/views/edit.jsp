...
<body>
	...
	<form action="edit.do" method="POST">
			...
			<label for="description">Description:</label> <input type="text" name="description" value="${film.description }" required>
			<br>
			
			<label for="releaseYear">Release Year:</label> <input type="number"name="releaseYear" value="${film.releaseYear }" required>
			...
			<label for="rentalRate">Rental Rate</label> <input type="number" name="rentalRate" value="${ film.rentalRate}">
			
			<label for="length">Length</label><input type="number" name="length" value="${film.length}">
			
			<label for="replacementCost">Replacement Cost:</label> <input type="number" name="replacementCost" value="${film.replacementCost}">
